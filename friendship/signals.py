...
def approve_friendship_post(sender, instance, **kwargs):
    if instance.approved and instance.old_approved != instance.approved:
        Friends.objects.create(friendShip=instance, user=instance.author, friend=instance.recipient)
        Friends.objects.create(friendShip=instance, user=instance.recipient, friend=instance.author)
